...
local isreg = function(reg)
    if reg == "WR" or reg == "CR" or reg == "PC3" or reg == "SP" then
        return true
    else
...
local isBasic = function(tabInst)
    ...
    if mnemonic == "slp" or mnemonic == "jif" or mnemonic == "jmp" or mnemonic == "pop" or mnemonic == "push" or mnemonic == "ret" or mnemonic == "call" then
        if #tabInst == 1 then
            return INST_BAS
        else
            return INST_ERR
