...
/* Compile command: gcc "objsrc/reflet-fpu-asm.c" -o "objsrc/reflet-fpu-asm" -fwrapv -g -lm */
/* Compile hash: 2vvGA6AzfZwM3jdK64RmbyFqKte8 */
/* ------------------------------ DIRECTIVES -------------------------------- */
#ifdef __GNUC__
  #ifndef __cplusplus
...
typedef nlmulret_nlboolean_nlint64_nlpointer (*function_3ADyvJeJQrNBg7LTe)(nelua_vector_pointer__ptr, int64_t);
typedef struct nlmulret_function_3ADyvJeJQrNBg7LTe_nelua_vector_pointer__ptr_nlint64 {
  function_3ADyvJeJQrNBg7LTe r1;
  nelua_vector_pointer__ptr r2;
  int64_t r3;
} nlmulret_function_3ADyvJeJQrNBg7LTe_nelua_vector_pointer__ptr_nlint64;
static nelua_inline nlmulret_function_3ADyvJeJQrNBg7LTe_nelua_vector_pointer__ptr_nlint64 nelua_ipairs_1(nelua_vector_pointer__ptr a);
...
typedef nlmulret_nlboolean_nlpointer_nelua_GCItem_ptr (*function_2emT2zJ4gT3s7DomS)(nelua_hashmap_iteratorT_ptr, void*);
typedef struct nlmulret_function_2emT2zJ4gT3s7DomS_nelua_hashmap_iteratorT_nlpointer {
  function_2emT2zJ4gT3s7DomS r1;
  nelua_hashmap_iteratorT r2;
  void* r3;
} nlmulret_function_2emT2zJ4gT3s7DomS_nelua_hashmap_iteratorT_nlpointer;
static nelua_inline nlmulret_function_2emT2zJ4gT3s7DomS_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a);
...
static nelua_inline nlmulret_function_2emT2zJ4gT3s7DomS_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self);
...
typedef void (*function_1vmhDU51hCEAFmiK)(nelua_GC_ptr);
...
typedef void (*function_269kZqcwHBSaHToaE)(void*, void*);
static void nelua_GC_maybecollect(nelua_GC_ptr self);
static void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_269kZqcwHBSaHToaE finalizer, void* userdata);
...
typedef int (*function_35n6f8P58maQjBU2K)(int, nlcstring_ptr);
...
typedef int (*function_4GDc5rZDY8gymPAKd)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_4GDc5rZDY8gymPAKd closef;
...
static nlmulret_nlboolean_nlusize nelua_stringbuilderT_write_3(nelua_stringbuilderT_ptr self, intptr_t __arg1);
static nlmulret_nlboolean_nlusize nelua_stringbuilderT_write_4(nelua_stringbuilderT_ptr self, parser_pure_line __arg1);
static nlmulret_nlboolean_nlusize nelua_stringbuilderT_write_5(nelua_stringbuilderT_ptr self, parser_pure_file __arg1);
static nlmulret_nlboolean_nlusize nelua_stringbuilderT_write_6(nelua_stringbuilderT_ptr self, bool __arg1);
static nlmulret_nlboolean_nlusize nelua_stringbuilderT_write_7(nelua_stringbuilderT_ptr self, uint8_t __arg1);
static nlmulret_nlboolean_nlusize nelua_stringbuilderT_write_8(nelua_stringbuilderT_ptr self, assembler_block_types __arg1);
static nlmulret_nlboolean_nlusize nelua_stringbuilderT_write_10(nelua_stringbuilderT_ptr self, double __arg1);
typedef struct nlmulret_nlboolean_nlcint {
  bool r1;
  int r2;
} nlmulret_nlboolean_nlcint;
static nlmulret_nlboolean_nlcint nelua_formatarg_2(nelua_stringbuilderT_ptr self, uint8_t c, char* buff, uintptr_t maxitem, nluint8_arr32_ptr form, uint8_t arg1);
...
static double nelua_nlstring___div_1(nlstring a, int64_t b);
static int64_t nelua_nlstring___bnot_1(nlstring a);
...
static nlstring nelua_tostring_4(parser_pure_file x);
...
static nlstring nelua_tostring_9(double x);
...
static void nelua_assert_line_64(bool cond);
static void nelua_assert_line_65(bool cond, nlstring msg);
static int64_t nelua_tonumber_2(int64_t x, nlniltype base);
static int64_t nelua_tointeger_1(nlstring x, nlniltype base);
static void nelua_assert_line_66(bool cond);
static void nelua_assert_line_67(bool cond, nlstring msg);
static int64_t nelua_tointeger_2(nlstring x, int64_t base);
...
typedef int (*function_5XBmmn8hjyDgjzuoL)(FILE_ptr);
static nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_5XBmmn8hjyDgjzuoL closef);
...
static nlstring parser_pure_file___tostring(parser_pure_file_ptr self);
...
static void nelua_print_2(intptr_t a1);
...
static nlstring assembler_block___tostring(assembler_block_ptr self);
...
typedef nlmulret_nelua_vector_block__assembler_error_t (*function_2fLavYWkEhBbkV3Wh)(nelua_vector_block_, int64_t);
static nlmulret_nelua_vector_block__assembler_error_t assembler_run_step(nelua_vector_block_ in_block, function_2fLavYWkEhBbkV3Wh step, int64_t addr_size);
...
static char nelua_strlit_3[561] = "@define set+ 1\n\t@align_word\n\tset 8\n\tadd PC\n\tload PC\n\tcpy R11\n\tset 3\n\tcpy R12\n\t@set_wordsize_byte\n\tadd R12\n\tadd PC\n\tjmp\n\t@constant $1\n@end\n\n@define setlab 1\n\t@align_word\n\tset 8\n\tadd PC\n\tload PC\n\tcpy R11\n\tset 3\n\tcpy R12\n\t@set_wordsize_byte\n\tadd R12\n\tadd PC\n\tjmp\n\t@labref $1\n@end\n\n@define goto 1\n\tsetlab $1\n\tjmp\n@end\n\n@define callf 1\n\tsetlab $1\n\tcall\n@end\n\n@define mov 2\n\tpush\n\tread $2\n\tcpy $1\n\tpop\n@end\n\n@define setr 2\n\tpush\n\tset+ $2\n\tcpy $1\n\tpop\n@end\n\n@define pushr 1\n\tcpy R12\n\tread $1\n\tpush\n\tread R12\n@end\n\n@define popr 1\n\tcpy R12\n\tpop\n\tcpy $1\n\tread R12\n@end\n\n";
...
nlmulret_function_3ADyvJeJQrNBg7LTe_nelua_vector_pointer__ptr_nlint64 nelua_ipairs_1(nelua_vector_pointer__ptr a) {
  return (nlmulret_function_3ADyvJeJQrNBg7LTe_nelua_vector_pointer__ptr_nlint64){nelua_ipairs_next, a, -1};
}
nlmulret_function_2emT2zJ4gT3s7DomS_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a) {
  nlmulret_function_2emT2zJ4gT3s7DomS_nelua_hashmap_iteratorT_nlpointer _ret_1 = nelua_hashmap_pointer__GCItem____mpairs(a);
  return (nlmulret_function_2emT2zJ4gT3s7DomS_nelua_hashmap_iteratorT_nlpointer){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
...
uintptr_t nelua_scanformat(nluint8_arr0_ptr strfmt, nluint8_arr32_ptr form) {
  ...
  nelua_assert_line_17((!nelua_isdigit(strfmt[p])), ((nlstring){(uint8_t*)"invalid format (width or precision too long)", 44}));
  form->v[0] = 37U;
...
void* nelua_GeneralAllocator_xalloc0(nelua_GeneralAllocator_ptr self, uintptr_t size) {
  ...
  nelua_assert_line_18((p != (void*)NULL), ((nlstring){(uint8_t*)"out of memory", 13}));
  return p;
}
...
nelua_span_string_ nelua_GeneralAllocator_xspanrealloc_3(nelua_GeneralAllocator_ptr self, nelua_span_string_ s, uintptr_t size) {
  ...
  nelua_assert_line_21((s.size == size), ((nlstring){(uint8_t*)"out of memory", 13}));
  return s;
}
...
nelua_span_hashmapnode_pointer__GCItem__ nelua_GeneralAllocator_xspanrealloc0_1(nelua_GeneralAllocator_ptr self, nelua_span_hashmapnode_pointer__GCItem__ s, uintptr_t size) {
  ...
  nelua_assert_line_22((s.size == size), ((nlstring){(uint8_t*)"out of memory", 13}));
  return s;
}
...
nlmulret_function_2emT2zJ4gT3s7DomS_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self) {
  return (nlmulret_function_2emT2zJ4gT3s7DomS_nelua_hashmap_iteratorT_nlpointer){nelua_hashmap_iteratorT_mnext, (nelua_hashmap_iteratorT){.container = self, .index = UINTPTR_MAX}, NULL};
}
...
uintptr_t nelua_hashmap_string__uint64___at(nelua_hashmap_string__uint64__ptr self, nlstring key) {
  ...
  if((node_index != UINTPTR_MAX)) {
    ...
    nelua_assert_line_26((node_index_2 < self->nodes.size), ((nlstring){(uint8_t*)"not enough space to add a node", 30}));
...
nluint8_ptr nelua_vector_uint8____atindex(nelua_vector_uint8__ptr self, uintptr_t i) {
  nelua_assert_line_31((i < self->size), ((nlstring){(uint8_t*)"position out of bounds", 22}));
...
assembler_block_ptr nelua_vector_block____atindex(nelua_vector_block__ptr self, uintptr_t i) {
  nelua_assert_line_32((i < self->size), ((nlstring){(uint8_t*)"position out of bounds", 22}));
...
void nelua_GC_unmarkall(nelua_GC_ptr self) {
  {
    nlmulret_function_2emT2zJ4gT3s7DomS_nelua_hashmap_iteratorT_nlpointer _asgnret_1 = nelua_mpairs_1((&self->items));
    function_2emT2zJ4gT3s7DomS __fornext = _asgnret_1.r1;
...
void nelua_GC_markstack(nelua_GC_ptr self) {
  jmp_buf regs = {0};
  setjmp(regs);
  volatile function_1vmhDU51hCEAFmiK markstackinner = nelua_GC_markstackinner;
  markstackinner(self);
}
...
void nelua_GC_sweep(nelua_GC_ptr self) {
  ...
  if(finalize) {
    {
      nlmulret_function_3ADyvJeJQrNBg7LTe_nelua_vector_pointer__ptr_nlint64 _asgnret_3 = nelua_ipairs_1((&self->frees));
      function_3ADyvJeJQrNBg7LTe __fornext = _asgnret_3.r1;
      ...
      while(true) {
        ...
        __forit;
        {
          if((ptr != NULL)) {
            ...
            nelua_assert_line_33((item != NULL), ((nlstring){(uint8_t*)"gc item not found to finalize", 29}));
            if((item->finalizer != NULL)) {
  ...
  {
    nlmulret_function_3ADyvJeJQrNBg7LTe_nelua_vector_pointer__ptr_nlint64 _asgnret_5 = nelua_ipairs_1((&self->frees));
    function_3ADyvJeJQrNBg7LTe __fornext = _asgnret_5.r1;
    ...
    while(true) {
      ...
      __forit;
      {
        if((ptr != NULL)) {
          nelua_GCItem item = nelua_hashmap_pointer__GCItem__remove((&self->items), ptr);
          nelua_assert_line_34((item.ptr == ptr), ((nlstring){(uint8_t*)"gc item not found to deallocate", 31}));
          self->membytes = (self->membytes - item.size);
...
void nelua_GC_registerroots(nelua_GC_ptr self) {
  nelua_GC_register((&nelua_gc), (void*)(&nelua_io_stderr), 8U, 2U, (function_269kZqcwHBSaHToaE)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_io_stdout), 8U, 2U, (function_269kZqcwHBSaHToaE)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_io_stdin), 8U, 2U, (function_269kZqcwHBSaHToaE)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_arg), 8U, 2U, (function_269kZqcwHBSaHToaE)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_stderrfs), 16U, 2U, (function_269kZqcwHBSaHToaE)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_stdoutfs), 16U, 2U, (function_269kZqcwHBSaHToaE)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_stdinfs), 16U, 2U, (function_269kZqcwHBSaHToaE)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&macro_list), 24U, 2U, (function_269kZqcwHBSaHToaE)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&assemble_line_instruction_list), 896U, 2U, (function_269kZqcwHBSaHToaE)NULL, (void*)NULL);
}
...
void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_269kZqcwHBSaHToaE finalizer, void* userdata) {
  if(nelua_unlikely((!(ptr != NULL)))) {
    return;
  }
  if((size < 8)) {
  ...
  nelua_assert_line_35((item->ptr == (void*)NULL), ((nlstring){(uint8_t*)"cannot register pointer twice", 29}));
...
bool nelua_GC_reregister(nelua_GC_ptr self, void* oldptr, void* newptr, uintptr_t newsize) {
  nelua_assert_line_36((((oldptr != NULL) && (newptr != NULL)) && (newsize > 0)), ((nlstring){(uint8_t*)"invalid pointer reregister arguments", 36}));
...
int main(int argc, nlcstring_ptr argv) {
  ...
  volatile function_35n6f8P58maQjBU2K inner_main = nelua_main;
...
nelua_FStream_ptr nelua_GCAllocator_new_2(nelua_GCAllocator_ptr self, nelua_FStream what, nlniltype size) {
  ...
  nelua_assert_line_37((ptr != ((nelua_FStream_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
...
void* nelua_GCAllocator_xalloc(nelua_GCAllocator_ptr self, uintptr_t size) {
  ...
  nelua_assert_line_38((p != (void*)NULL), ((nlstring){(uint8_t*)"out of memory", 13}));
  return p;
}
...
nelua_span_usize_ nelua_GCAllocator_xspanrealloc_7(nelua_GCAllocator_ptr self, nelua_span_usize_ s, uintptr_t size) {
  ...
  nelua_assert_line_45((s.size == size), ((nlstring){(uint8_t*)"out of memory", 13}));
  return s;
}
...
nelua_span_hashmapnode_string__uint64__ nelua_GCAllocator_xspanrealloc0_1(nelua_GCAllocator_ptr self, nelua_span_hashmapnode_string__uint64__ s, uintptr_t size) {
  ...
  nelua_assert_line_46((s.size == size), ((nlstring){(uint8_t*)"out of memory", 13}));
  return s;
}
...
void nelua_stringbuilderT_commit(nelua_stringbuilderT_ptr self, uintptr_t n) {
  ...
  nelua_assert_line_47((newsize <= self->data.size), ((nlstring){(uint8_t*)"not enough space in string buffer", 33}));
  self->size = newsize;
}
...
nlmulret_nlboolean_nlusize nelua_stringbuilderT_write_3(nelua_stringbuilderT_ptr self, intptr_t __arg1) {
  uintptr_t written = (uintptr_t)0U;
  nlstring s = nelua_tostring_3(__arg1);
  if((s.size > 0)) {
    nelua_span_uint8_ p = nelua_stringbuilderT_prepare(self, s.size);
    if(nelua_unlikely(nelua_span_uint8__empty((&p)))) {
      nlmulret_nlboolean_nlusize _mulret_1;
...
nlmulret_nlboolean_nlusize nelua_stringbuilderT_write_4(nelua_stringbuilderT_ptr self, parser_pure_line __arg1) {
  uintptr_t written = (uintptr_t)0U;
...
nlmulret_nlboolean_nlusize nelua_stringbuilderT_write_5(nelua_stringbuilderT_ptr self, parser_pure_file __arg1) {
  uintptr_t written = (uintptr_t)0U;
  nlstring s = nelua_tostring_4(__arg1);
  if((s.size > 0)) {
    nelua_span_uint8_ p = nelua_stringbuilderT_prepare(self, s.size);
    if(nelua_unlikely(nelua_span_uint8__empty((&p)))) {
      nlmulret_nlboolean_nlusize _mulret_1;
...
nlmulret_nlboolean_nlusize nelua_stringbuilderT_write_6(nelua_stringbuilderT_ptr self, bool __arg1) {
  uintptr_t written = (uintptr_t)0U;
...
nlmulret_nlboolean_nlusize nelua_stringbuilderT_write_7(nelua_stringbuilderT_ptr self, uint8_t __arg1) {
  uintptr_t written = (uintptr_t)0U;
...
nlmulret_nlboolean_nlusize nelua_stringbuilderT_write_8(nelua_stringbuilderT_ptr self, assembler_block_types __arg1) {
  uintptr_t written = (uintptr_t)0U;
  nlstring s = nelua_tostring_7(__arg1);
  if((s.size > 0)) {
    nelua_span_uint8_ p = nelua_stringbuilderT_prepare(self, s.size);
    if(nelua_unlikely(nelua_span_uint8__empty((&p)))) {
      nlmulret_nlboolean_nlusize _mulret_1;
...
nlmulret_nlboolean_nlusize nelua_stringbuilderT_write_10(nelua_stringbuilderT_ptr self, double __arg1) {
  uintptr_t written = (uintptr_t)0U;
  nlstring s = nelua_tostring_9(__arg1);
  if((s.size > 0)) {
    nelua_span_uint8_ p = nelua_stringbuilderT_prepare(self, s.size);
    if(nelua_unlikely(nelua_span_uint8__empty((&p)))) {
      nlmulret_nlboolean_nlusize _mulret_1;
...
nlmulret_nlboolean_nlcint nelua_formatarg_2(nelua_stringbuilderT_ptr self, uint8_t c, char* buff, uintptr_t maxitem, nluint8_arr32_ptr form, uint8_t arg1) {
  int nb = -1;
  if((c == 99U)) {
    int n = (int)arg1;
  ...
  nelua_assert_line_48(false, ((nlstring){(uint8_t*)"invalid format for argument", 27}));
nelua_next_6:;
  nelua_assert_line_49(((nb >= 0) && (nb < (intptr_t)maxitem)), ((nlstring){(uint8_t*)"unexpected number of bytes written in sprintf", 45}));
...
nelua_next_2:;
        ...
        nelua_assert_line_50((nb >= 0), ((nlstring){(uint8_t*)"missing argument in format", 26}));
...
nlstring_ptr nelua_sequence_string__1___atindex(nelua_sequence_string__1_ptr self, uintptr_t i) {
  ...
  if(nelua_unlikely((i > self->impl->size))) {
    nelua_assert_line_51((i == (self->impl->size + 1)), ((nlstring){(uint8_t*)"position out of bounds", 22}));
...
nlstring nelua_nlstring_create(uintptr_t size) {
  nelua_assert_line_52((size > 0), ((nlstring){(uint8_t*)"attempt to create an empty string", 33}));
...
uint8_t nelua_nlstring_byte_1(nlstring s, nlniltype i) {
  ...
  nelua_assert_line_53(((i_1 >= 1) && ((uintptr_t)i_1 <= s.size)), ((nlstring){(uint8_t*)"index out of range", 18}));
  return s.data[(i_1 - 1)];
}
...
double nelua_nlstring___div_1(nlstring a, int64_t b) {
  double a_2 = nelua_tonumber_1(a, NLNIL);
  int64_t b_1 = nelua_tonumber_2(b, NLNIL);
  return (a_2 / b_1);
}
int64_t nelua_nlstring___bnot_1(nlstring a) {
  int64_t a_3 = nelua_tointeger_1(a, NLNIL);
  return (~a_3);
}
...
int64_t nelua_str2intbase(nlstring s, uint64_t base) {
  nelua_assert_line_54((s.size > 0), ((nlstring){(uint8_t*)"invalid number format", 21}));
  nelua_assert_line_55(((base >= 2) && (base <= 36)), ((nlstring){(uint8_t*)"base out of range", 17}));
  uintptr_t pos = (uintptr_t)0U;
  while(((pos < s.size) && (isspace((int)s.data[pos]) != 0))) {
    pos = (pos + 1);
  }
  nelua_assert_line_56((pos < s.size), ((nlstring){(uint8_t*)"invalid number format", 21}));
  bool neg = false;
  if((s.data[pos] == 45U)) {
    pos = (pos + 1);
    neg = true;
  ...
  while((pos < s.size)) {
    ...
    nelua_assert_line_57((x < (int)base), ((nlstring){(uint8_t*)"invalid number format", 21}));
    n = ((n * base) + (uint64_t)x);
    pos = (pos + 1);
  }
  while(((pos < s.size) && (isspace((int)s.data[pos]) != 0))) {
  ...
  nelua_assert_line_58((pos == s.size), ((nlstring){(uint8_t*)"invalid number format", 21}));
  if(neg) {
    n = (-n);
  }
  return (int64_t)n;
...
nlstring nelua_tostring_2(int64_t x) {
  ...
  nelua_assert_line_59(((size >= 0) && (size < 47)), ((nlstring){(uint8_t*)"tostring format failed or truncated", 35}));
...
nlstring nelua_tostring_3(intptr_t x) {
  ...
  nelua_assert_line_60(((size >= 0) && (size < 47)), ((nlstring){(uint8_t*)"tostring format failed or truncated", 35}));
  return nelua_nlstring_copy((nlstring){((nluint8_arr0_ptr)(&tmpbuf.v[0])), nelua_assert_narrow_nlcint_nlusize(size)});
}
nlstring nelua_tostring_4(parser_pure_file x) {
  return parser_pure_file___tostring((&x));
}
nlstring nelua_tostring_5(bool x) {
  if((x == true)) {
    return nelua_nlstring_copy(((nlstring){(uint8_t*)"true", 4}));
  }
  return nelua_nlstring_copy(((nlstring){(uint8_t*)"false", 5}));
}
...
nlstring nelua_tostring_6(uint8_t x) {
  nluint8_arr48 tmpbuf;
  tmpbuf.v[47] = (uint8_t)0U;
  int size = snprintf((char*)(&tmpbuf), 47U, "%" PRIu8, x);
  nelua_assert_line_61(((size >= 0) && (size < 47)), ((nlstring){(uint8_t*)"tostring format failed or truncated", 35}));
  return nelua_nlstring_copy((nlstring){((nluint8_arr0_ptr)(&tmpbuf.v[0])), nelua_assert_narrow_nlcint_nlusize(size)});
}
...
nlstring nelua_tostring_7(assembler_block_types x) {
  ...
  tmpbuf.v[47] = (uint8_t)0U;
  int size = snprintf((char*)(&tmpbuf), 47U, "%" PRIi64, x);
  nelua_assert_line_62(((size >= 0) && (size < 47)), ((nlstring){(uint8_t*)"tostring format failed or truncated", 35}));
  return nelua_nlstring_copy((nlstring){((nluint8_arr0_ptr)(&tmpbuf.v[0])), nelua_assert_narrow_nlcint_nlusize(size)});
}
...
nlstring nelua_tostring_9(double x) {
  nluint8_arr48 tmpbuf;
  tmpbuf.v[47] = (uint8_t)0U;
  int size = snprintf((char*)(&tmpbuf), 47U, "%.14g", x);
  if((tmpbuf.v[nelua_assert_bounds_nlcsize(strspn((char*)(&tmpbuf.v[0]), "-0123456789"), 48)] == 0)) {
    size = snprintf((char*)(&tmpbuf), 47U, "%.1f", x);
  }
  nelua_assert_line_63(((size >= 0) && (size < 47)), ((nlstring){(uint8_t*)"tostring format failed or truncated", 35}));
  return nelua_nlstring_copy((nlstring){((nluint8_arr0_ptr)(&tmpbuf.v[0])), nelua_assert_narrow_nlcint_nlusize(size)});
}
void nelua_assert_line_64(bool cond){
  if(nelua_unlikely(!cond)) {
    fwrite("/usr/local/lib/nelua/lib/string.nelua\033[1m:763:21: \033[31m\033[1mruntime error: \033[0m\033[1massertion failed!\033[0m\n    assert(tocstring(&tmpbuf, #tmpbuf, x)) -- ensure it's zero terminated\n                    \033[1m\033[32m^\033[0m\033[35m~~~~~~~~~~~~~~~~~~~~\033[0m\n", 1, 242, stderr);
    nelua_abort();
  }
}
void nelua_assert_line_65(bool cond, nlstring msg){
  if(nelua_unlikely(!cond)) {
    fwrite("/usr/local/lib/nelua/lib/string.nelua\033[1m:767:44: \033[31m\033[1mruntime error: \033[0m\033[1m", 1, 82, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
double nelua_tonumber_1(nlstring x, nlniltype base) {
  ...
  nelua_assert_line_64(nelua_tocstring(((nlcchar_arr0_ptr)(&tmpbuf)), 65U, x));
  errno = 0;
  double n = strtod((char*)(&tmpbuf), (&endptr));
  uintptr_t len = ((uintptr_t)endptr - (uintptr_t)(&tmpbuf));
  nelua_assert_line_65((((len > 0) && (len <= (uintptr_t)nelua_nlstring___len(x))) && (errno == 0)), ((nlstring){(uint8_t*)"failed to convert string to number", 34}));
  return n;
}
int64_t nelua_tonumber_2(int64_t x, nlniltype base) {
  return x;
}
void nelua_assert_line_66(bool cond){
  if(nelua_unlikely(!cond)) {
...
int64_t nelua_tointeger_1(nlstring x, nlniltype base) {
  char* endptr = NULL;
  nlcchar_arr65 tmpbuf = {0};
  nelua_assert_line_66(nelua_tocstring(((nlcchar_arr0_ptr)(&tmpbuf)), 65U, x));
  errno = 0;
  long long i = strtoll((char*)(&tmpbuf), (&endptr), 10);
  uintptr_t len = ((uintptr_t)endptr - (uintptr_t)(&tmpbuf));
  nelua_assert_line_67((((len > 0) && (len <= (uintptr_t)nelua_nlstring___len(x))) && (errno == 0)), ((nlstring){(uint8_t*)"failed to convert string to integer", 35}));
  return (int64_t)i;
}
...
int64_t nelua_tointeger_2(nlstring x, int64_t base) {
...
nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_5XBmmn8hjyDgjzuoL closef) {
...
nlmulret_nelua_filestream_nlstring_nlint64 nelua_filestream_open_1(nlstring filename, nlstring mode) {
  nelua_assert_line_68(nelua_checkmode(mode), ((nlstring){(uint8_t*)"invalid mode", 12}));
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_close(nelua_filestream_ptr self) {
  ...
  self->fs->closef = (function_4GDc5rZDY8gymPAKd)NULL;
  nlmulret_nlboolean_nlstring_nlint64 _mulret_1;
...
nlstring parser_pure_file___tostring(parser_pure_file_ptr self) {
  nelua_stringbuilderT builder = {0};
  nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"len = ", 6}));
  nelua_stringbuilderT_write_3((&builder), parser_pure_file___len(self));
  nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"\n", 1}));
  for(intptr_t i = 0, _end = parser_pure_file___len(self); i < _end; i = i + 1) {
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"# ", 2}));
    nelua_stringbuilderT_write_4((&builder), parser_pure_file___index(self, (int64_t)i));
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"\n", 1}));
  }
  return nelua_stringbuilderT_promote((&builder));
}
  ...
  for(intptr_t i = 0, _end = parser_pure_file___len((&m.content)); i < _end; i = i + 1) {
    ...
    for(int64_t j = 0, _end = parser_pure_line___len((&curr_line)); j < _end; j = j + 1) {
      ...
      if(nelua_nlstring___eq(nelua_nlstring_sub_1(curr_word, 1, 1), ((nlstring){(uint8_t*)"$", 1}))) {
        ...
        int64_t arg_num = nelua_tointeger_1(nelua_nlstring_sub_1(curr_word, 2, nelua_nlstring___len(curr_word)), NLNIL);
        if((arg_num < 1)) {
          return false;
        }
      }
...
void nelua_print_2(intptr_t a1) {
  fprintf(stdout, "%" PRIiPTR, a1);
  fputc('\n', stdout);
  fflush(stdout);
}
bool assemble_line_is_reg_valid(nlstring reg) {
  ...
  if(((nelua_nlstring___len(reg) != 2) && (nelua_nlstring___bnot_1(reg) != 3))) {
    return false;
  }
  if((!nelua_nlstring___eq(nelua_nlstring_sub_1(reg_UP, 1, 1), ((nlstring){(uint8_t*)"R", 1})))) {
    return false;
  }
  nelua_print_2(nelua_nlstring___len(reg));
  nlstring number_1 = nelua_nlstring_sub_1(reg, 2, nelua_nlstring___len(reg));
  nelua_print_1(number_1);
  int64_t true_num = nelua_tointeger_1(number_1, NLNIL);
  if(((true_num < 0) || (true_num > 15))) {
    return false;
  }
  return true;
}
uint8_t assemble_line_reg_to_num(nlstring reg) {
  ...
  nelua_print_1(reg);
  return (uint8_t)nelua_tointeger_1(nelua_nlstring_sub_1(reg, 2, nelua_nlstring___len(reg)), NLNIL);
}
bool assemble_line_is_line_valid(parser_pure_line line) {
  ...
  if((inst.argument == 2)) {
    int64_t arg_num = nelua_tointeger_1(parser_pure_line___index((&line), 1), NLNIL);
    if(((0 > arg_num) || (arg_num > 3))) {
      return false;
    }
  }
  if((inst.argument == 3)) {
    int64_t arg_num = nelua_tointeger_1(parser_pure_line___index((&line), 1), NLNIL);
    if(((0 > arg_num) || (arg_num > 15))) {
      return false;
    }
  }
  return true;
...
uint8_t assemble_line_asm_line(parser_pure_line line) {
  uint8_t ret = 0U;
  assemble_line_instruction inst = assemble_line_get_inst(parser_pure_line___index((&line), 0));
  nelua_print_1(parser_pure_line___tostring((&line)));
  if((inst.argument == 0)) {
    ret = inst.opcode;
  } else if((inst.argument == 1)) {
    ret = ((inst.opcode << 4) | assemble_line_reg_to_num(parser_pure_line___index((&line), 1)));
  } else if((inst.argument == 2)) {
    ret = nelua_assert_narrow_nlint64_nluint8((int64_t)((inst.opcode << 2) | nelua_tointeger_1(parser_pure_line___index((&line), 1), NLNIL)));
  } else if((inst.argument == 3)) {
    ret = nelua_assert_narrow_nlint64_nluint8((int64_t)((inst.opcode << 4) | nelua_tointeger_1(parser_pure_line___index((&line), 1), NLNIL)));
  }
  return ret;
}
...
nlstring assembler_block___tostring(assembler_block_ptr self) {
  nelua_stringbuilderT builder = {0};
  if((self->type == 1)) {
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"Type = Pure File\nFilename = ", 28}));
    nelua_stringbuilderT_write_1((&builder), self->content.pure_file.name);
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)" ; place = ", 11}));
    nelua_stringbuilderT_write_2((&builder), self->content.pure_file.place);
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)" ; content = [", 14}));
    nelua_stringbuilderT_write_5((&builder), self->content.pure_file.content);
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"]\n", 2}));
  } else if((self->type == 7)) {
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"Type = Label; ID = ", 19}));
    nelua_stringbuilderT_write_1((&builder), self->content.label.id);
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)" ; set ? ", 9}));
    nelua_stringbuilderT_write_6((&builder), self->content.label.set);
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"\n", 1}));
  } else if((self->type == 2)) {
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"Type = Machine Code; code = ", 28}));
    nelua_stringbuilderT_write_7((&builder), self->content.machine_code.code);
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)" ; detail: ", 11}));
    nelua_stringbuilderT_write_1((&builder), self->content.machine_code.comment);
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"\n", 1}));
  } else if((self->type == 3)) {
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"Type = Alignment Directive; align to ", 37}));
    nelua_stringbuilderT_write_2((&builder), self->content.alignment_directive.byte_alignment);
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"bytes\n", 6}));
  } else if((self->type == 5)) {
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"Type = Raw Byte; value = ", 25}));
    nelua_stringbuilderT_write_1((&builder), nelua_nlstring_format_2(((nlstring){(uint8_t*)"0x%02X", 6}), self->content.rawbyte.content));
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"\n", 1}));
  } else {
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"Unsupported type: ", 18}));
    nelua_stringbuilderT_write_8((&builder), self->type);
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"\n", 1}));
  }
  return nelua_stringbuilderT_promote((&builder));
}
    ...
    if(((*(assembler_block*)nelua_assert_deref(nelua_vector_block____atindex((&ret), nelua_assert_narrow_nlisize_nlusize(i)))).type == 1)) {
      ...
      for(intptr_t j = 0, _end = parser_pure_file___len((&file)); j < _end; j = j + 1) {
        ...
        if(nelua_nlstring___eq(parser_pure_line___index((&line), 0), ((nlstring){(uint8_t*)"@define", 7}))) {
          ...
          bool macro_ok = macro_register_macro(parser_pure_line___index((&line), 1), nelua_tointeger_1(parser_pure_line___index((&line), 2), NLNIL), macro_1);
          if((!macro_ok)) {
            assembler_error_in_file((*(assembler_block*)nelua_assert_deref(nelua_vector_block____atindex((&in_block), nelua_assert_narrow_nlisize_nlusize(i)))).content.pure_file, (int64_t)j);
          ...
          assembler_alignment_directive_block lab_blk = (assembler_alignment_directive_block){nelua_tointeger_1(parser_pure_line___index((&line), 1), NLNIL)};
          assembler_block new_block = {0};
          new_block.type = 3;
          ...
          assembler_constant_block lab_blk = (assembler_constant_block){nelua_tointeger_1(parser_pure_line___index((&line), 1), NLNIL)};
          assembler_block new_block = {0};
          new_block.type = 4;
          ...
          for(int64_t i_2 = 1, _end = parser_pure_line___len((&line)); i_2 < _end; i_2 = i_2 + 1) {
            nelua_vector_uint8__push((&raws), nelua_assert_narrow_nlint64_nluint8(nelua_tointeger_2(parser_pure_line___index((&line), i_2), 16)));
          }
...
nlmulret_nelua_vector_block__assembler_error_t assembler_third_step(nelua_vector_block_ in_block, int64_t addr_size) {
  nelua_vector_block_ ret = nelua_vector_block__copy((&in_block));
  for(intptr_t i = 0, _end = nelua_vector_block____len((&in_block)); i < _end; i = i + 1) {
    nelua_print_1(assembler_block___tostring((&(*(assembler_block*)nelua_assert_deref(nelua_vector_block____atindex((&ret), nelua_assert_narrow_nlisize_nlusize(i)))))));
    if(((*(assembler_block*)nelua_assert_deref(nelua_vector_block____atindex((&ret), nelua_assert_narrow_nlisize_nlusize(i)))).type == 1)) {
      parser_pure_file file = (*(assembler_block*)nelua_assert_deref(nelua_vector_block____atindex((&ret), nelua_assert_narrow_nlisize_nlusize(i)))).content.pure_file.content;
...
nlmulret_nelua_vector_block__assembler_error_t assembler_run_step(nelua_vector_block_ in_block, function_2fLavYWkEhBbkV3Wh step, int64_t addr_size) {
...
nlmulret_nelua_vector_uint8__assembler_error_t assembler_assemble(nlstring input_file, nlstring runtime_start, nlstring runtime_end, int64_t addr_size, int64_t start_addr) {
  ...
  nelua_print_1(((nlstring){(uint8_t*)"3", 1}));
  if((err3 != 0)) {
  ...
  nelua_print_1(((nlstring){(uint8_t*)"4", 1}));
  if((err4 != 0)) {
...
main_arg_flags main_parse_args() {
  main_arg_flags flags = (main_arg_flags){false, false, ((nlstring){(uint8_t*)"", 0}), ((nlstring){(uint8_t*)"", 0}), -1, true, -1, 0, false};
  int64_t i = 1;
  ...
  while((i <= nelua_sequence_string__1___len((&nelua_arg)))) {
    if((((nelua_nlstring___eq((*(nlstring*)nelua_assert_deref(nelua_sequence_string__1___atindex((&nelua_arg), nelua_assert_narrow_nlint64_nlusize(i)))), ((nlstring){(uint8_t*)"-h", 2})) || nelua_nlstring___eq((*(nlstring*)nelua_assert_deref(nelua_sequence_string__1___atindex((&nelua_arg), nelua_assert_narrow_nlint64_nlusize(i)))), ((nlstring){(uint8_t*)"-help", 5}))) || nelua_nlstring___eq((*(nlstring*)nelua_assert_deref(nelua_sequence_string__1___atindex((&nelua_arg), nelua_assert_narrow_nlint64_nlusize(i)))), ((nlstring){(uint8_t*)"--help", 6}))) || nelua_nlstring___eq((*(nlstring*)nelua_assert_deref(nelua_sequence_string__1___atindex((&nelua_arg), nelua_assert_narrow_nlint64_nlusize(i)))), ((nlstring){(uint8_t*)"help", 4})))) {
      ...
      if((i == nelua_sequence_string__1___len((&nelua_arg)))) {
        ...
        flags.word_size = nelua_tointeger_1((*(nlstring*)nelua_assert_deref(nelua_sequence_string__1___atindex((&nelua_arg), nelua_assert_narrow_nlint64_nlusize((i + 1))))), NLNIL);
        i = (i + 1);
      }
      ...
      if((i == nelua_sequence_string__1___len((&nelua_arg)))) {
        ...
        flags.stack_value = nelua_tointeger_1((*(nlstring*)nelua_assert_deref(nelua_sequence_string__1___atindex((&nelua_arg), nelua_assert_narrow_nlint64_nlusize((i + 1))))), NLNIL);
        i = (i + 1);
      }
      ...
      if((i == nelua_sequence_string__1___len((&nelua_arg)))) {
        ...
        flags.start_addr = nelua_tointeger_1((*(nlstring*)nelua_assert_deref(nelua_sequence_string__1___atindex((&nelua_arg), nelua_assert_narrow_nlint64_nlusize((i + 1))))), NLNIL);
        i = (i + 1);
      }
...
void main_check_flags_ok(main_arg_flags flags) {
  if(flags.error) {
    nelua_filestream_write_4((&nelua_io_stderr), ((nlstring){(uint8_t*)"Error, invalid arguments.\n", 26}), ((nlstring){(uint8_t*)nelua_strlit_1, 730}));
    nelua_os_exit_1(-1);
  }
  if(flags.help) {
    nelua_filestream_write_1((&nelua_io_stdout), ((nlstring){(uint8_t*)nelua_strlit_1, 730}));
    nelua_os_exit_1(0);
  }
...
nlstring main_make_start_runtime(main_arg_flags flags) {
  ...
  nelua_stringbuilderT_write_10((&builder), nelua_nlstring___div_1(nelua_tostring_2(word_size), 8));
  nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"\n@end\n", 6}));
  nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)nelua_strlit_3, 560}));
  if(flags.set_stack) {
...
assembler_error_t main_reflet_fpu_asm_main() {
  ...
  nelua_print_1(((nlstring){(uint8_t*)"Done parsing args.\n", 19}));
