...
/* Compile hash: 2rpNHtsKSoEAM23o4gCWhNiKjza8 */
/* ------------------------------ DIRECTIVES -------------------------------- */
#ifdef __GNUC__
  #ifndef __cplusplus
...
typedef nlmulret_nlboolean_nlint64_nlpointer (*function_3dGESPtRknN2b5tD7)(nelua_vector_pointer__ptr, int64_t);
typedef struct nlmulret_function_3dGESPtRknN2b5tD7_nelua_vector_pointer__ptr_nlint64 {
  function_3dGESPtRknN2b5tD7 r1;
  nelua_vector_pointer__ptr r2;
  int64_t r3;
} nlmulret_function_3dGESPtRknN2b5tD7_nelua_vector_pointer__ptr_nlint64;
static nelua_inline nlmulret_function_3dGESPtRknN2b5tD7_nelua_vector_pointer__ptr_nlint64 nelua_ipairs_1(nelua_vector_pointer__ptr a);
...
typedef nlmulret_nlboolean_nlpointer_nelua_GCItem_ptr (*function_4K75wPj5gpEspVwTF)(nelua_hashmap_iteratorT_ptr, void*);
typedef struct nlmulret_function_4K75wPj5gpEspVwTF_nelua_hashmap_iteratorT_nlpointer {
  function_4K75wPj5gpEspVwTF r1;
  nelua_hashmap_iteratorT r2;
  void* r3;
} nlmulret_function_4K75wPj5gpEspVwTF_nelua_hashmap_iteratorT_nlpointer;
static nelua_inline nlmulret_function_4K75wPj5gpEspVwTF_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a);
...
static nelua_inline nlmulret_function_4K75wPj5gpEspVwTF_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self);
...
typedef void (*function_56zg7akFmSDtDVBNo)(nelua_GC_ptr);
...
typedef void (*function_2zy1Q1AfAbsHCZ3Wz)(void*, void*);
static void nelua_GC_maybecollect(nelua_GC_ptr self);
static void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_2zy1Q1AfAbsHCZ3Wz finalizer, void* userdata);
...
typedef int (*function_2M1BUAep5xHNPAo2q)(int, nlcstring_ptr);
...
typedef int (*function_3eWvHZsbTSxDdSzkt)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_3eWvHZsbTSxDdSzkt closef;
...
typedef int (*function_3UJZ5cWgbb9aBJDCB)(FILE_ptr);
static nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_3UJZ5cWgbb9aBJDCB closef);
...
typedef nlmulret_nelua_vector_block__assembler_error_t (*function_4ApyT9vyVjGaJSYKo)(nelua_vector_block_, int64_t);
static nlmulret_nelua_vector_block__assembler_error_t assembler_run_step(nelua_vector_block_ in_block, function_4ApyT9vyVjGaJSYKo step, int64_t addr_size);
...
static char nelua_strlit_3[589] = "@define set+ 1\n\t@align_word\n\tset 8\n\tadd PC\n\tload PC\n\tcpy R11\n\tset 3\n\tcpy R12\n\t@set_wordsize_byte\n\tadd R12\n\tadd PC\n\tjmp\n\t@constant $1\n@end\n\n@define setlab 1\n\t@align_word\n\tset 8\n\tadd PC\n\tload PC\n\tcpy R11\n\tset 3\n\tcpy R12\n\t@set_wordsize_byte\n\tadd R12\n\tadd PC\n\tjmp\n\t@labref $1\n@end\n\n@define goto 1\n\tsetlab $1\n\tjmp\n@end\n\n@define callf 1\n\tsetlab $1\n\tcall\n@end\n\n@define mov 2\n\tpush\n\tread $2\n\tcpy $1\n\tpop\n@end\n\n@define setr 2\n\tpush\n\tset+ $2\n\tcpy $1\n\tpop\n@end\n\n@define pushr 1\n\tcpy R12\n\tread $1\n\tpush\n\tread R12\n@end\n\n@define popr 1\n\tcpy R12\n\tpop\n\tcpy $1\n\tread R12\n@end\n\n@define jmp 0\n\tcpy PC\n@end\n\n";
...
nlmulret_function_3dGESPtRknN2b5tD7_nelua_vector_pointer__ptr_nlint64 nelua_ipairs_1(nelua_vector_pointer__ptr a) {
  return (nlmulret_function_3dGESPtRknN2b5tD7_nelua_vector_pointer__ptr_nlint64){nelua_ipairs_next, a, -1};
}
nlmulret_function_4K75wPj5gpEspVwTF_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a) {
  nlmulret_function_4K75wPj5gpEspVwTF_nelua_hashmap_iteratorT_nlpointer _ret_1 = nelua_hashmap_pointer__GCItem____mpairs(a);
  return (nlmulret_function_4K75wPj5gpEspVwTF_nelua_hashmap_iteratorT_nlpointer){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
...
nlmulret_function_4K75wPj5gpEspVwTF_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self) {
  return (nlmulret_function_4K75wPj5gpEspVwTF_nelua_hashmap_iteratorT_nlpointer){nelua_hashmap_iteratorT_mnext, (nelua_hashmap_iteratorT){.container = self, .index = UINTPTR_MAX}, NULL};
}
...
void nelua_GC_unmarkall(nelua_GC_ptr self) {
  {
    nlmulret_function_4K75wPj5gpEspVwTF_nelua_hashmap_iteratorT_nlpointer _asgnret_1 = nelua_mpairs_1((&self->items));
    function_4K75wPj5gpEspVwTF __fornext = _asgnret_1.r1;
...
void nelua_GC_markstack(nelua_GC_ptr self) {
  jmp_buf regs = {0};
  setjmp(regs);
  volatile function_56zg7akFmSDtDVBNo markstackinner = nelua_GC_markstackinner;
  markstackinner(self);
}
...
void nelua_GC_sweep(nelua_GC_ptr self) {
  ...
  if(finalize) {
    {
      nlmulret_function_3dGESPtRknN2b5tD7_nelua_vector_pointer__ptr_nlint64 _asgnret_3 = nelua_ipairs_1((&self->frees));
      function_3dGESPtRknN2b5tD7 __fornext = _asgnret_3.r1;
  ...
  {
    nlmulret_function_3dGESPtRknN2b5tD7_nelua_vector_pointer__ptr_nlint64 _asgnret_5 = nelua_ipairs_1((&self->frees));
    function_3dGESPtRknN2b5tD7 __fornext = _asgnret_5.r1;
...
void nelua_GC_registerroots(nelua_GC_ptr self) {
  nelua_GC_register((&nelua_gc), (void*)(&nelua_io_stderr), 8U, 2U, (function_2zy1Q1AfAbsHCZ3Wz)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_io_stdout), 8U, 2U, (function_2zy1Q1AfAbsHCZ3Wz)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_io_stdin), 8U, 2U, (function_2zy1Q1AfAbsHCZ3Wz)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_arg), 8U, 2U, (function_2zy1Q1AfAbsHCZ3Wz)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_stderrfs), 16U, 2U, (function_2zy1Q1AfAbsHCZ3Wz)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_stdoutfs), 16U, 2U, (function_2zy1Q1AfAbsHCZ3Wz)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_stdinfs), 16U, 2U, (function_2zy1Q1AfAbsHCZ3Wz)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&macro_list), 24U, 2U, (function_2zy1Q1AfAbsHCZ3Wz)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&assemble_line_instruction_list), 896U, 2U, (function_2zy1Q1AfAbsHCZ3Wz)NULL, (void*)NULL);
}
...
void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_2zy1Q1AfAbsHCZ3Wz finalizer, void* userdata) {
  if(nelua_unlikely((!(ptr != NULL)))) {
    return;
  }
  if((size < 8)) {
...
int main(int argc, nlcstring_ptr argv) {
  ...
  volatile function_2M1BUAep5xHNPAo2q inner_main = nelua_main;
...
nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_3UJZ5cWgbb9aBJDCB closef) {
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_close(nelua_filestream_ptr self) {
  ...
  self->fs->closef = (function_3eWvHZsbTSxDdSzkt)NULL;
  nlmulret_nlboolean_nlstring_nlint64 _mulret_1;
...
nlmulret_nelua_vector_block__assembler_error_t assembler_run_step(nelua_vector_block_ in_block, function_4ApyT9vyVjGaJSYKo step, int64_t addr_size) {
...
nlstring main_make_start_runtime(main_arg_flags flags) {
  ...
  nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"\n@end\n", 6}));
  nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)nelua_strlit_3, 588}));
  if(flags.set_stack) {
