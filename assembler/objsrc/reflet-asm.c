...
/* Compile hash: 2Vq9kf3vCURFXQrfdwZC415vByUK */
/* ------------------------------ DIRECTIVES -------------------------------- */
#ifdef __GNUC__
  #ifndef __cplusplus
...
nlstring main_make_start_runtime(main_arg_flags flags) {
  ...
  nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"\n@end\n", 6}));
  nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)nelua_strlit_3, 1020}));
  if((!flags.no_prefix)) {
