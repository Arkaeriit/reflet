...
/* Compile hash: 4WWy9JwLGtzKMbVDsYDJNhYRNsY7 */
/* ------------------------------ DIRECTIVES -------------------------------- */
...
typedef nlmulret_nlboolean_nlstring_nluint64 (*function_JqPeHwUgiMWG5EXx)(nelua_hashmap_iteratorT_1_ptr, nlstring);
...
typedef struct nlmulret_function_JqPeHwUgiMWG5EXx_nelua_hashmap_iteratorT_1_nlstring {
  function_JqPeHwUgiMWG5EXx r1;
  nelua_hashmap_iteratorT_1 r2;
  nlstring r3;
} nlmulret_function_JqPeHwUgiMWG5EXx_nelua_hashmap_iteratorT_1_nlstring;
static NELUA_INLINE nlmulret_function_JqPeHwUgiMWG5EXx_nelua_hashmap_iteratorT_1_nlstring nelua_pairs_1(nelua_hashmap_string__uint64__ptr a);
...
static NELUA_INLINE nlmulret_function_JqPeHwUgiMWG5EXx_nelua_hashmap_iteratorT_1_nlstring nelua_hashmap_string__uint64____pairs(nelua_hashmap_string__uint64__ptr self);
...
static void nelua_vector_uint8__reserve(nelua_vector_uint8__ptr self, uintptr_t n);
...
typedef struct NELUA_MAYALIAS nluint8_arr0 {uint8_t v[0];} nluint8_arr0;
typedef union NELUA_MAYALIAS nluint8_arr0_cast {nluint8_arr0 a; uint8_t p[0];} nluint8_arr0_cast;
static NELUA_INLINE nelua_vector_uint8_ nelua_vector_uint8____convert_1(nluint8_arr0 values);
...
static NELUA_INLINE nelua_vector_uint8_ nelua_vector_uint8____convert_2(nluint8_arr1 values);
...
static NELUA_INLINE nelua_vector_uint8_ nelua_vector_uint8____convert_3(nluint8_arr2 values);
...
typedef int (*function_pi3mLo3SPgsdVsJW)(int, nlcstring_ptr);
...
static assembler_block assembler_make_string(nlstring raw_line, nelua_vector_uint8_ sufix);
...
typedef nlmulret_nelua_vector_block__assembler_error_t (*function_3R6e5K17n3sNZQLKz)(nelua_vector_block_, int64_t);
static nlmulret_nelua_vector_block__assembler_error_t assembler_run_step(nelua_vector_block_ in_block, function_3R6e5K17n3sNZQLKz step, int64_t addr_size);
...
nlmulret_function_JqPeHwUgiMWG5EXx_nelua_hashmap_iteratorT_1_nlstring nelua_pairs_1(nelua_hashmap_string__uint64__ptr a) {
  nlmulret_function_JqPeHwUgiMWG5EXx_nelua_hashmap_iteratorT_1_nlstring _ret_1 = nelua_hashmap_string__uint64____pairs(a);
  return (nlmulret_function_JqPeHwUgiMWG5EXx_nelua_hashmap_iteratorT_1_nlstring){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
...
nlmulret_function_JqPeHwUgiMWG5EXx_nelua_hashmap_iteratorT_1_nlstring nelua_hashmap_string__uint64____pairs(nelua_hashmap_string__uint64__ptr self) {
  return (nlmulret_function_JqPeHwUgiMWG5EXx_nelua_hashmap_iteratorT_1_nlstring){nelua_hashmap_iteratorT_1_next, (nelua_hashmap_iteratorT_1){.container = self, .index = 0xffffffffffffffffULL}, (nlstring){0}};
}
...
void nelua_vector_uint8__reserve(nelua_vector_uint8__ptr self, uintptr_t n) {
  if(NELUA_LIKELY((self->data.size >= n))) {
    return;
  }
  self->data = nelua_GCAllocator_xspanrealloc_1((&self->allocator), self->data, n);
}
...
nelua_vector_uint8_ nelua_vector_uint8____convert_1(nluint8_arr0 values) {
  nelua_vector_uint8_ self = (nelua_vector_uint8_){0};
  nelua_vector_uint8__reserve((&self), 0x0U);
  self.size = 0x0U;
  for(uintptr_t i = 0U; i < 0x0U; i += 1) {
    (*(uint8_t*)nelua_assert_deref(nelua_span_uint8____atindex(self.data, i))) = values.v[i];
  }
  return self;
}
nelua_vector_uint8_ nelua_vector_uint8____convert_2(nluint8_arr1 values) {
  nelua_vector_uint8_ self = (nelua_vector_uint8_){0};
  nelua_vector_uint8__reserve((&self), 1U);
  self.size = 1U;
  for(uintptr_t i = 0U; i < 1U; i += 1) {
    (*(uint8_t*)nelua_assert_deref(nelua_span_uint8____atindex(self.data, i))) = values.v[nelua_assert_bounds_nlusize(i, 1)];
  }
  return self;
}
nelua_vector_uint8_ nelua_vector_uint8____convert_3(nluint8_arr2 values) {
  nelua_vector_uint8_ self = (nelua_vector_uint8_){0};
  nelua_vector_uint8__reserve((&self), 2U);
  self.size = 2U;
  for(uintptr_t i = 0U; i < 2U; i += 1) {
    (*(uint8_t*)nelua_assert_deref(nelua_span_uint8____atindex(self.data, i))) = values.v[nelua_assert_bounds_nlusize(i, 2)];
  }
  return self;
}
...
int main(int argc, nlcstring_ptr argv) {
  ...
  volatile function_pi3mLo3SPgsdVsJW inner_main = nelua_main;
...
assembler_block assembler_make_string(nlstring raw_line, nelua_vector_uint8_ sufix) {
  intptr_t first_space_index = -1;
  for(intptr_t i = 1, _end = nelua_nlstring___len(raw_line); i <= _end; i += 1) {
    if(nelua_nlstring___eq(nelua_nlstring_sub_1(raw_line, i, i), ((nlstring){(uint8_t*)" ", 1}))) {
      first_space_index = i;
      break;
    }
  }
  ...
  if((first_space_index != -1)) {
    nlstring str = nelua_nlstring_sub_1(raw_line, (first_space_index + 1), nelua_nlstring___len(raw_line));
    for(intptr_t i = 1, _end = nelua_nlstring___len(str); i <= _end; i += 1) {
      nelua_vector_uint8__push((&raws), nelua_nlstring_byte_1(nelua_nlstring_sub_1(str, i, i), NELUA_NIL));
    }
  }
  for(intptr_t i = 0, _end = nelua_vector_uint8____len((&sufix)); i < _end; i += 1) {
    nelua_vector_uint8__push((&raws), (*(uint8_t*)nelua_assert_deref(nelua_vector_uint8____atindex((&sufix), nelua_assert_narrow_nlisize_nlusize(i)))));
  }
    ...
    if(((*(assembler_block*)nelua_assert_deref(nelua_vector_block____atindex((&ret), nelua_assert_narrow_nlisize_nlusize(i)))).type == 1)) {
      ...
      for(intptr_t j = 0, _end = parser_pure_file___len((&file)); j < _end; j += 1) {
        ...
        if(nelua_nlstring___eq(parser_pure_line___index((&line), 0), ((nlstring){(uint8_t*)"@define", 7}))) {
          ...
          assembler_block new_block = assembler_make_string(line.raw, nelua_vector_uint8____convert_1((nluint8_arr0){}));
          ret = assembler_insert_block_in_file(ret, (int64_t)i, (int64_t)j, new_block);
          return (nlmulret_nelua_vector_block__assembler_error_t){ret, -1};
        } else if(nelua_nlstring___eq(parser_pure_line___index((&line), 0), ((nlstring){(uint8_t*)"@string-0", 9}))) {
          assembler_block new_block = assembler_make_string(line.raw, nelua_vector_uint8____convert_2((nluint8_arr1){{0U}}));
          ret = assembler_insert_block_in_file(ret, (int64_t)i, (int64_t)j, new_block);
          return (nlmulret_nelua_vector_block__assembler_error_t){ret, -1};
        } else if(nelua_nlstring___eq(parser_pure_line___index((&line), 0), ((nlstring){(uint8_t*)"@string-nl", 10}))) {
          assembler_block new_block = assembler_make_string(line.raw, nelua_vector_uint8____convert_2((nluint8_arr1){{10U}}));
          ret = assembler_insert_block_in_file(ret, (int64_t)i, (int64_t)j, new_block);
          return (nlmulret_nelua_vector_block__assembler_error_t){ret, -1};
        } else if(nelua_nlstring___eq(parser_pure_line___index((&line), 0), ((nlstring){(uint8_t*)"@string-nl-0", 12}))) {
          assembler_block new_block = assembler_make_string(line.raw, nelua_vector_uint8____convert_3((nluint8_arr2){{10U, 0U}}));
          ret = assembler_insert_block_in_file(ret, (int64_t)i, (int64_t)j, new_block);
          return (nlmulret_nelua_vector_block__assembler_error_t){ret, -1};
        }
      }
...
nlmulret_nelua_vector_block__assembler_error_t assembler_third_step(nelua_vector_block_ in_block, int64_t addr_size) {
  ...
  for(intptr_t i = 0, _end = nelua_vector_block____len((&in_block)); i < _end; i += 1) {
    if(((*(assembler_block*)nelua_assert_deref(nelua_vector_block____atindex((&ret), nelua_assert_narrow_nlisize_nlusize(i)))).type == 1)) {
      ...
      for(int64_t i_3 = 0, _end = addr_size; i_3 < _end; i_3 += 1) {
...
void assembler_print_labels(nelua_hashmap_string__uint64_ map) {
  nelua_stringbuilderT builder = (nelua_stringbuilderT){0};
  {
    nlmulret_function_JqPeHwUgiMWG5EXx_nelua_hashmap_iteratorT_1_nlstring _asgnret_1 = nelua_pairs_1((&map));
    function_JqPeHwUgiMWG5EXx __fornext = _asgnret_1.r1;
...
nlmulret_nelua_vector_block__assembler_error_t assembler_run_step(nelua_vector_block_ in_block, function_3R6e5K17n3sNZQLKz step, int64_t addr_size) {
