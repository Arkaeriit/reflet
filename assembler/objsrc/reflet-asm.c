...
/* Compile hash: 5VKWP9AK77KA4iwXCnuC9XBVt81 */
/* ------------------------------ DIRECTIVES -------------------------------- */
#ifdef __GNUC__
  #ifndef __cplusplus
...
nlstring main_make_start_runtime(main_arg_flags flags) {
  ...
  nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)nelua_strlit_4, 1088}));
  if((!flags.no_prefix)) {
