...
/* Compile hash: bRpv6nzdQ4ih9VbAqagHM6CxVfk */
/* ------------------------------ DIRECTIVES -------------------------------- */
#ifdef __GNUC__
  #ifndef __cplusplus
...
typedef nlmulret_nlboolean_nlint64_nlpointer (*function_5GwiLSUuzTWYkXJAw)(nelua_vector_pointer__ptr, int64_t);
typedef struct nlmulret_function_5GwiLSUuzTWYkXJAw_nelua_vector_pointer__ptr_nlint64 {
  function_5GwiLSUuzTWYkXJAw r1;
  nelua_vector_pointer__ptr r2;
  int64_t r3;
} nlmulret_function_5GwiLSUuzTWYkXJAw_nelua_vector_pointer__ptr_nlint64;
static nelua_inline nlmulret_function_5GwiLSUuzTWYkXJAw_nelua_vector_pointer__ptr_nlint64 nelua_ipairs_1(nelua_vector_pointer__ptr a);
...
typedef nlmulret_nelua_vector_block__assembler_error_t (*function_4ipMfRSutVpNjyakr)(nelua_vector_block_, int64_t);
static nlmulret_nelua_vector_block__assembler_error_t assembler_run_step(nelua_vector_block_ in_block, function_4ipMfRSutVpNjyakr step, int64_t addr_size);
...
nlmulret_function_5GwiLSUuzTWYkXJAw_nelua_vector_pointer__ptr_nlint64 nelua_ipairs_1(nelua_vector_pointer__ptr a) {
  return (nlmulret_function_5GwiLSUuzTWYkXJAw_nelua_vector_pointer__ptr_nlint64){nelua_ipairs_next, a, -1};
}
...
void nelua_GC_sweep(nelua_GC_ptr self) {
  ...
  if(finalize) {
    {
      nlmulret_function_5GwiLSUuzTWYkXJAw_nelua_vector_pointer__ptr_nlint64 _asgnret_3 = nelua_ipairs_1((&self->frees));
      function_5GwiLSUuzTWYkXJAw __fornext = _asgnret_3.r1;
  ...
  {
    nlmulret_function_5GwiLSUuzTWYkXJAw_nelua_vector_pointer__ptr_nlint64 _asgnret_5 = nelua_ipairs_1((&self->frees));
    function_5GwiLSUuzTWYkXJAw __fornext = _asgnret_5.r1;
...
nlmulret_nelua_vector_block__assembler_error_t assembler_run_step(nelua_vector_block_ in_block, function_4ipMfRSutVpNjyakr step, int64_t addr_size) {
