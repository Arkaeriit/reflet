...
/* Compile hash: 3Awhbzuv7ndCsxjGJmNS7MUS6Ar8 */
/* ------------------------------ DIRECTIVES -------------------------------- */
...
typedef nlmulret_nlboolean_nlstring_nluint64 (*function_33TUPy3PUGmJXR5bK)(nelua_hashmap_iteratorT_1_ptr, nlstring);
...
typedef struct nlmulret_function_33TUPy3PUGmJXR5bK_nelua_hashmap_iteratorT_1_nlstring {
  function_33TUPy3PUGmJXR5bK r1;
  nelua_hashmap_iteratorT_1 r2;
  nlstring r3;
} nlmulret_function_33TUPy3PUGmJXR5bK_nelua_hashmap_iteratorT_1_nlstring;
static NELUA_INLINE nlmulret_function_33TUPy3PUGmJXR5bK_nelua_hashmap_iteratorT_1_nlstring nelua_pairs_1(nelua_hashmap_string__uint64__ptr a);
...
typedef nlmulret_nlboolean_nlpointer_nelua_GCItem_ptr (*function_todu6ou4ub3Ahixm)(nelua_hashmap_iteratorT_ptr, void*);
...
typedef struct nlmulret_function_todu6ou4ub3Ahixm_nelua_hashmap_iteratorT_nlpointer {
  function_todu6ou4ub3Ahixm r1;
  nelua_hashmap_iteratorT r2;
  void* r3;
} nlmulret_function_todu6ou4ub3Ahixm_nelua_hashmap_iteratorT_nlpointer;
static NELUA_INLINE nlmulret_function_todu6ou4ub3Ahixm_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a);
...
static NELUA_INLINE nlmulret_function_todu6ou4ub3Ahixm_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self);
...
static NELUA_INLINE nlmulret_function_33TUPy3PUGmJXR5bK_nelua_hashmap_iteratorT_1_nlstring nelua_hashmap_string__uint64____pairs(nelua_hashmap_string__uint64__ptr self);
...
typedef void (*function_2b2PD437DLSbCTZsD)(nelua_GC_ptr);
...
typedef void (*function_3Evwrr1rBELCKATyM)(void*, void*);
static bool nelua_GC_step(nelua_GC_ptr self);
static void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_3Evwrr1rBELCKATyM finalizer, void* userdata);
...
typedef int (*function_5b8S5xxfTBXzodGT4)(int, nlcstring_ptr);
...
typedef int (*function_39yZLmfQeZSVBzKZy)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_39yZLmfQeZSVBzKZy closef;
};
...
typedef int (*function_UcDVMJS12CK7oJcK)(FILE_ptr);
static nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_UcDVMJS12CK7oJcK closef);
...
typedef nlmulret_nelua_vector_block__assembler_error_t (*function_2KydYnKUsX6GJNPd9)(nelua_vector_block_, int64_t);
static nlmulret_nelua_vector_block__assembler_error_t assembler_run_step(nelua_vector_block_ in_block, function_2KydYnKUsX6GJNPd9 step, int64_t addr_size);
...
nlmulret_function_33TUPy3PUGmJXR5bK_nelua_hashmap_iteratorT_1_nlstring nelua_pairs_1(nelua_hashmap_string__uint64__ptr a) {
  nlmulret_function_33TUPy3PUGmJXR5bK_nelua_hashmap_iteratorT_1_nlstring _ret_1 = nelua_hashmap_string__uint64____pairs(a);
  return (nlmulret_function_33TUPy3PUGmJXR5bK_nelua_hashmap_iteratorT_1_nlstring){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
nlmulret_function_todu6ou4ub3Ahixm_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a) {
  nlmulret_function_todu6ou4ub3Ahixm_nelua_hashmap_iteratorT_nlpointer _ret_1 = nelua_hashmap_pointer__GCItem____mpairs(a);
  return (nlmulret_function_todu6ou4ub3Ahixm_nelua_hashmap_iteratorT_nlpointer){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
...
nlmulret_function_todu6ou4ub3Ahixm_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self) {
  return (nlmulret_function_todu6ou4ub3Ahixm_nelua_hashmap_iteratorT_nlpointer){nelua_hashmap_iteratorT_mnext, (nelua_hashmap_iteratorT){.container = self, .index = 0xffffffffffffffffULL}, NULL};
}
...
nlmulret_function_33TUPy3PUGmJXR5bK_nelua_hashmap_iteratorT_1_nlstring nelua_hashmap_string__uint64____pairs(nelua_hashmap_string__uint64__ptr self) {
  return (nlmulret_function_33TUPy3PUGmJXR5bK_nelua_hashmap_iteratorT_1_nlstring){nelua_hashmap_iteratorT_1_next, (nelua_hashmap_iteratorT_1){.container = self, .index = 0xffffffffffffffffULL}, (nlstring){0}};
}
...
void nelua_GC_unmarkall(nelua_GC_ptr self) {
  {
    nlmulret_function_todu6ou4ub3Ahixm_nelua_hashmap_iteratorT_nlpointer _asgnret_1 = nelua_mpairs_1((&self->items));
    function_todu6ou4ub3Ahixm __fornext = _asgnret_1.r1;
...
void nelua_GC_mark(nelua_GC_ptr self) {
  ...
  if((self->stackbottom != 0)) {
    volatile function_2b2PD437DLSbCTZsD markstack = nelua_GC_markstack;
    markstack(self);
  }
}
...
void nelua_GC_registerroots(nelua_GC_ptr self) {
  nelua_GC_register((&nelua_gc), (void*)(&nelua_arg), 8U, 131072U, (function_3Evwrr1rBELCKATyM)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_io_stderr), 8U, 131072U, (function_3Evwrr1rBELCKATyM)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_io_stdout), 8U, 131072U, (function_3Evwrr1rBELCKATyM)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_stderrfs), 16U, 131072U, (function_3Evwrr1rBELCKATyM)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_stdoutfs), 16U, 131072U, (function_3Evwrr1rBELCKATyM)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&macro_list), 24U, 131072U, (function_3Evwrr1rBELCKATyM)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&assemble_line_instruction_list), 896U, 131072U, (function_3Evwrr1rBELCKATyM)NULL, (void*)NULL);
}
...
void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_3Evwrr1rBELCKATyM finalizer, void* userdata) {
  if(NELUA_UNLIKELY((!(ptr != NULL)))) {
    return;
  }
...
int main(int argc, nlcstring_ptr argv) {
  ...
  volatile function_5b8S5xxfTBXzodGT4 inner_main = nelua_main;
...
nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_UcDVMJS12CK7oJcK closef) {
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_close(nelua_filestream_ptr self) {
  ...
  self->fs->closef = (function_39yZLmfQeZSVBzKZy)NULL;
  if((res != 0)) {
    nlmulret_nlstring_nlint64 _ret_1 = nelua_geterrno();
...
void assembler_print_labels(nelua_hashmap_string__uint64_ map) {
  nelua_stringbuilderT builder = (nelua_stringbuilderT){0};
  {
    nlmulret_function_33TUPy3PUGmJXR5bK_nelua_hashmap_iteratorT_1_nlstring _asgnret_1 = nelua_pairs_1((&map));
    function_33TUPy3PUGmJXR5bK __fornext = _asgnret_1.r1;
...
nlmulret_nelua_vector_block__assembler_error_t assembler_run_step(nelua_vector_block_ in_block, function_2KydYnKUsX6GJNPd9 step, int64_t addr_size) {
...
nlstring main_make_start_runtime(main_arg_flags flags) {
  ...
  nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)nelua_strlit_4, 2402}));
  if((!flags.no_prefix)) {
