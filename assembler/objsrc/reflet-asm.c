...
/* Compile command: gcc "objsrc/reflet-asm.c" -o "objsrc/reflet-asm" -fwrapv -g -lm */
/* Compile hash: 9Cd9bDusUqQEAuJXFfdVYom8jtC */
/* ------------------------------ DIRECTIVES -------------------------------- */
#ifdef __GNUC__
  #ifndef __cplusplus
...
typedef nlmulret_nlboolean_nlint64_nlpointer (*function_352qXiEuncSF93nD1)(nelua_vector_pointer__ptr, int64_t);
typedef struct nlmulret_function_352qXiEuncSF93nD1_nelua_vector_pointer__ptr_nlint64 {
  function_352qXiEuncSF93nD1 r1;
  nelua_vector_pointer__ptr r2;
  int64_t r3;
} nlmulret_function_352qXiEuncSF93nD1_nelua_vector_pointer__ptr_nlint64;
static nelua_inline nlmulret_function_352qXiEuncSF93nD1_nelua_vector_pointer__ptr_nlint64 nelua_ipairs_1(nelua_vector_pointer__ptr a);
...
typedef nlmulret_nlboolean_nlstring_nluint64 (*function_3yKfa3ymuY1zfzjTv)(nelua_hashmap_iteratorT_1_ptr, nlstring);
typedef struct nlmulret_function_3yKfa3ymuY1zfzjTv_nelua_hashmap_iteratorT_1_nlstring {
  function_3yKfa3ymuY1zfzjTv r1;
  nelua_hashmap_iteratorT_1 r2;
  nlstring r3;
} nlmulret_function_3yKfa3ymuY1zfzjTv_nelua_hashmap_iteratorT_1_nlstring;
static nelua_inline nlmulret_function_3yKfa3ymuY1zfzjTv_nelua_hashmap_iteratorT_1_nlstring nelua_pairs_1(nelua_hashmap_string__uint64__ptr a);
...
typedef nlmulret_nlboolean_nlpointer_nelua_GCItem_ptr (*function_5YcSnxa8W2vPfzRe)(nelua_hashmap_iteratorT_ptr, void*);
typedef struct nlmulret_function_5YcSnxa8W2vPfzRe_nelua_hashmap_iteratorT_nlpointer {
  function_5YcSnxa8W2vPfzRe r1;
  nelua_hashmap_iteratorT r2;
  void* r3;
} nlmulret_function_5YcSnxa8W2vPfzRe_nelua_hashmap_iteratorT_nlpointer;
static nelua_inline nlmulret_function_5YcSnxa8W2vPfzRe_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a);
...
static nelua_inline nlmulret_function_5YcSnxa8W2vPfzRe_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self);
...
static nelua_inline nlmulret_function_3yKfa3ymuY1zfzjTv_nelua_hashmap_iteratorT_1_nlstring nelua_hashmap_string__uint64____pairs(nelua_hashmap_string__uint64__ptr self);
...
typedef void (*function_3ygr7VDfbmTjtKZbn)(nelua_GC_ptr);
...
typedef void (*function_5mdYqKy7qH29VNkVQ)(void*, void*);
static void nelua_GC_maybecollect(nelua_GC_ptr self);
static void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_5mdYqKy7qH29VNkVQ finalizer, void* userdata);
...
typedef int (*function_gFYHXZGkY7SRnKtQ)(int, nlcstring_ptr);
...
typedef int (*function_3oRyQbtb7tsTdwhG5)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_3oRyQbtb7tsTdwhG5 closef;
...
static nlmulret_nlboolean_nlcint nelua_formatarg_4(nelua_stringbuilderT_ptr self, uint8_t c, char* buff, uintptr_t maxitem, nluint8_arr32_ptr form, uint64_t arg1);
...
static nlstring nelua_tostring_10(uint64_t x);
...
static void nelua_assert_line_62(bool cond);
...
typedef int (*function_T4N8qFtU6rczRAHQ)(FILE_ptr);
static nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_T4N8qFtU6rczRAHQ closef);
...
typedef nlmulret_nelua_vector_block__assembler_error_t (*function_4P4HaANwYZrJRL5hJ)(nelua_vector_block_, int64_t);
static nlmulret_nelua_vector_block__assembler_error_t assembler_run_step(nelua_vector_block_ in_block, function_4P4HaANwYZrJRL5hJ step, int64_t addr_size);
...
static char nelua_strlit_4[1245] = ";This macro is used to put the result of the 2 word macro in the WR.\n;It is used to form set+ or setlab\n@define set_to_constant 2\n    mov R11 SR\n    set 0\n    cpy SR\n    @set_wordsize_byte\n    cpy R12\n    @align_word\n    slp ;four slp are used to ensure that the access is alligned for word_size of 32 or 64 bits. May not work for bigger word size.\n    slp\n    slp\n    slp\n    set 2\n    add R12\n    add PC\n    jmp\n    $1 $2\n    ;Jumped here\n    set 3\n    add R12 ;Contains the word size\n    cc2\n    add PC\n    load WR\n    mov SR R11\n@end\n\n@define set+ 1\n    set_to_constant @constant $1\n@end\n\n@define setlab 1\n    set_to_constant @labref $1\n@end\n\n@define goto 1\n    setlab $1\n    jmp\n@end\n\n@define callf 1\n    setlab $1\n    call\n@end\n\n@define mov 2\n    cpy R12\n    read $2\n    cpy $1\n    read R12\n@end\n\n@define setr 2\n    cpy R12\n    set+ $2\n    cpy $1\n    read R12\n@end\n\n@define pushr 1\n    cpy R12\n    read $1\n    push\n    read R12\n@end\n\n@define popr 1\n    cpy R12\n    pop\n    cpy $1\n    read R12\n@end\n\n@define jmp 0\n    cpy PC\n@end\n\n@define label 1\n    @label $1\n@end\n\n@define rawbyte 1\n    @rawbytes $1\n@end\n\n@define set8 1\n    @set8 $1\n@end\n\n@define load8 1\n    tbm\n    load $1\n    tbm\n@end\n\n@define str8 1\n    tbm\n    str $1\n    tbm\n@end\n";
...
nlmulret_function_352qXiEuncSF93nD1_nelua_vector_pointer__ptr_nlint64 nelua_ipairs_1(nelua_vector_pointer__ptr a) {
  return (nlmulret_function_352qXiEuncSF93nD1_nelua_vector_pointer__ptr_nlint64){nelua_ipairs_next, a, -1};
}
nlmulret_function_3yKfa3ymuY1zfzjTv_nelua_hashmap_iteratorT_1_nlstring nelua_pairs_1(nelua_hashmap_string__uint64__ptr a) {
  nlmulret_function_3yKfa3ymuY1zfzjTv_nelua_hashmap_iteratorT_1_nlstring _ret_1 = nelua_hashmap_string__uint64____pairs(a);
  return (nlmulret_function_3yKfa3ymuY1zfzjTv_nelua_hashmap_iteratorT_1_nlstring){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
nlmulret_function_5YcSnxa8W2vPfzRe_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a) {
  nlmulret_function_5YcSnxa8W2vPfzRe_nelua_hashmap_iteratorT_nlpointer _ret_1 = nelua_hashmap_pointer__GCItem____mpairs(a);
  return (nlmulret_function_5YcSnxa8W2vPfzRe_nelua_hashmap_iteratorT_nlpointer){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
...
nlmulret_function_5YcSnxa8W2vPfzRe_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self) {
  return (nlmulret_function_5YcSnxa8W2vPfzRe_nelua_hashmap_iteratorT_nlpointer){nelua_hashmap_iteratorT_mnext, (nelua_hashmap_iteratorT){.container = self, .index = UINTPTR_MAX}, NULL};
}
...
nlmulret_function_3yKfa3ymuY1zfzjTv_nelua_hashmap_iteratorT_1_nlstring nelua_hashmap_string__uint64____pairs(nelua_hashmap_string__uint64__ptr self) {
  return (nlmulret_function_3yKfa3ymuY1zfzjTv_nelua_hashmap_iteratorT_1_nlstring){nelua_hashmap_iteratorT_1_next, (nelua_hashmap_iteratorT_1){.container = self, .index = UINTPTR_MAX}, (nlstring){0}};
}
...
void nelua_GC_unmarkall(nelua_GC_ptr self) {
  {
    nlmulret_function_5YcSnxa8W2vPfzRe_nelua_hashmap_iteratorT_nlpointer _asgnret_1 = nelua_mpairs_1((&self->items));
    function_5YcSnxa8W2vPfzRe __fornext = _asgnret_1.r1;
...
void nelua_GC_markstack(nelua_GC_ptr self) {
  jmp_buf regs = {0};
  setjmp(regs);
  volatile function_3ygr7VDfbmTjtKZbn markstackinner = nelua_GC_markstackinner;
  markstackinner(self);
}
...
void nelua_GC_sweep(nelua_GC_ptr self) {
  ...
  if(finalize) {
    {
      nlmulret_function_352qXiEuncSF93nD1_nelua_vector_pointer__ptr_nlint64 _asgnret_3 = nelua_ipairs_1((&self->frees));
      function_352qXiEuncSF93nD1 __fornext = _asgnret_3.r1;
  ...
  {
    nlmulret_function_352qXiEuncSF93nD1_nelua_vector_pointer__ptr_nlint64 _asgnret_5 = nelua_ipairs_1((&self->frees));
    function_352qXiEuncSF93nD1 __fornext = _asgnret_5.r1;
...
void nelua_GC_registerroots(nelua_GC_ptr self) {
  nelua_GC_register((&nelua_gc), (void*)(&nelua_io_stderr), 8U, 2U, (function_5mdYqKy7qH29VNkVQ)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_io_stdout), 8U, 2U, (function_5mdYqKy7qH29VNkVQ)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_io_stdin), 8U, 2U, (function_5mdYqKy7qH29VNkVQ)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_arg), 8U, 2U, (function_5mdYqKy7qH29VNkVQ)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_stderrfs), 16U, 2U, (function_5mdYqKy7qH29VNkVQ)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_stdoutfs), 16U, 2U, (function_5mdYqKy7qH29VNkVQ)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&nelua_stdinfs), 16U, 2U, (function_5mdYqKy7qH29VNkVQ)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&macro_list), 24U, 2U, (function_5mdYqKy7qH29VNkVQ)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&assemble_line_instruction_list), 896U, 2U, (function_5mdYqKy7qH29VNkVQ)NULL, (void*)NULL);
}
...
void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_5mdYqKy7qH29VNkVQ finalizer, void* userdata) {
  if(nelua_unlikely((!(ptr != NULL)))) {
    return;
  }
  if((size < 8)) {
...
int main(int argc, nlcstring_ptr argv) {
  ...
  volatile function_gFYHXZGkY7SRnKtQ inner_main = nelua_main;
...
nelua_span_pure_line_ nelua_GCAllocator_spanalloc_2(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata) {
  ...
  if(nelua_likely((size > 0))) {
    parser_pure_line_arr0_ptr data = ((parser_pure_line_arr0_ptr)nelua_GCAllocator_alloc_2(self, (size * 824), flags_2, finalizer_2, userdata_2));
...
nelua_span_pure_line_ nelua_GCAllocator_spanrealloc_3(nelua_GCAllocator_ptr self, nelua_span_pure_line_ s, uintptr_t size) {
  ...
  parser_pure_line_arr0_ptr p = ((parser_pure_line_arr0_ptr)nelua_GCAllocator_realloc(self, (void*)s.data, (size * 824), s.size));
...
nlmulret_nlboolean_nlcint nelua_formatarg_4(nelua_stringbuilderT_ptr self, uint8_t c, char* buff, uintptr_t maxitem, nluint8_arr32_ptr form, uint64_t arg1) {
  int nb = -1;
  if((c == 99U)) {
    int n = (int)arg1;
  ...
  if((c == 115U)) {
    nlstring s = nelua_tostring_10(arg1);
    maxitem = (s.size + 1);
  ...
  while((pos < fmt.size)) {
    ...
    if((c != 37U)) {
      ...
      if((c == 37U)) {
        ...
        int nb = -1;
        if((1 == argi)) {
          nlmulret_nlboolean_nlcint _asgnret_1 = nelua_formatarg_4(self, c, buff, maxitem, (&form), __arg1);
          ok = _asgnret_1.r1;
          nb = _asgnret_1.r2;
          goto nelua_next_8;
        }
...
nlstring nelua_tostring_10(uint64_t x) {
  nluint8_arr48 tmpbuf;
  tmpbuf.v[47] = (uint8_t)0U;
  int size = snprintf((char*)(&tmpbuf), 47U, "%" PRIu64, x);
...
void nelua_assert_line_62(bool cond){
  if(nelua_unlikely(!cond)) {
...
int64_t nelua_tointeger_2(nlstring x, nlniltype base) {
  ...
  nelua_assert_line_62(nelua_tocstring(((nlcchar_arr0_ptr)(&tmpbuf)), 65U, x));
  errno = 0;
  long long i = strtoll((char*)(&tmpbuf), (&endptr), 10);
  uintptr_t len = ((uintptr_t)endptr - (uintptr_t)(&tmpbuf));
  nelua_assert_line_63((((len > 0) && (len <= (uintptr_t)nelua_nlstring___len(x))) && (errno == 0)), ((nlstring){(uint8_t*)"failed to convert string to integer", 35}));
  return (int64_t)i;
}
...
nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_T4N8qFtU6rczRAHQ closef) {
...
nlmulret_nelua_filestream_nlstring_nlint64 nelua_filestream_open_1(nlstring filename, nlstring mode) {
  nelua_assert_line_64(nelua_checkmode(mode), ((nlstring){(uint8_t*)"invalid mode", 12}));
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_close(nelua_filestream_ptr self) {
  ...
  self->fs->closef = (function_3oRyQbtb7tsTdwhG5)NULL;
  nlmulret_nlboolean_nlstring_nlint64 _mulret_1;
...
nlmulret_assembler_block_assembler_error_t assembler_gen_set8(int64_t num) {
  if(((num & -256) != 0)) {
    return (nlmulret_assembler_block_assembler_error_t){assembler_make_pure_file_block((assembler_pure_file_block){parser_purify_string(((nlstring){(uint8_t*)"", 0})), ((nlstring){(uint8_t*)"", 0}), 1, false, ((nlstring){(uint8_t*)"", 0})}), 3};
  }
  nelua_stringbuilderT builder = {0};
  ...
  assembler_pure_file_block local_block = (assembler_pure_file_block){code_block, ((nlstring){(uint8_t*)"set8", 4}), 1, true, ((nlstring){(uint8_t*)".", 1})};
    ...
    if(((*(assembler_block*)nelua_assert_deref(nelua_vector_block____atindex((&ret), nelua_assert_narrow_nlisize_nlusize(i)))).type == 1)) {
      ...
      for(intptr_t j = 0, _end = parser_pure_file___len((&file)); j < _end; j = j + 1) {
        ...
        if(nelua_nlstring___eq(parser_pure_line___index((&line), 0), ((nlstring){(uint8_t*)"@define", 7}))) {
          ...
          nlmulret_assembler_block_assembler_error_t _asgnret_3 = assembler_gen_set8(nelua_tointeger_2(parser_pure_line___index((&line), 1), NLNIL));
          assembler_block set8 = _asgnret_3.r1;
          assembler_error_t err = _asgnret_3.r2;
          if((err != 0)) {
            assembler_error_in_file((*(assembler_block*)nelua_assert_deref(nelua_vector_block____atindex((&in_block), nelua_assert_narrow_nlisize_nlusize(i)))).content.pure_file, (int64_t)j);
          ...
          for(int64_t i_2 = 1, _end = parser_pure_line___len((&line)); i_2 < _end; i_2 = i_2 + 1) {
            nlmulret_nlint64_nlboolean _asgnret_6 = utils_check_hex(parser_pure_line___index((&line), i_2));
          ...
          nelua_vector_uint8_ raws = {0};
          for(intptr_t i_3 = 1, _end = nelua_nlstring___len(str); i_3 <= _end; i_3 = i_3 + 1) {
            nelua_vector_uint8__push((&raws), nelua_nlstring_byte_1(nelua_nlstring_sub_1(str, i_3, i_3), NLNIL));
          }
          assembler_rawbytes_block lab_blk = (assembler_rawbytes_block){raws};
          assembler_block new_block = {0};
          new_block.type = 6;
...
void assembler_print_labels(nelua_hashmap_string__uint64_ map) {
  nelua_stringbuilderT builder = {0};
  {
    nlmulret_function_3yKfa3ymuY1zfzjTv_nelua_hashmap_iteratorT_1_nlstring _asgnret_1 = nelua_pairs_1((&map));
    function_3yKfa3ymuY1zfzjTv __fornext = _asgnret_1.r1;
    nelua_hashmap_iteratorT_1 __forstate = _asgnret_1.r2;
    nlstring __forit = _asgnret_1.r3;
    while(true) {
      bool __forcont;
      uint64_t v;
      nlmulret_nlboolean_nlstring_nluint64 _asgnret_2 = __fornext((&__forstate), __forit);
      __forcont = _asgnret_2.r1;
      __forit = _asgnret_2.r2;
      v = _asgnret_2.r3;
      if((!__forcont)) {
  ...
  for(intptr_t i = 0, _end = nelua_vector_block____len((&in_block)); i < _end; i = i + 1) {
    if(((*(assembler_block*)nelua_assert_deref(nelua_vector_block____atindex((&in_block), nelua_assert_narrow_nlisize_nlusize(i)))).type == 7)) {
      ...
      if((!label.set)) {
        ...
        for(int64_t i_5 = 0, _end = addr_size; i_5 < _end; i_5 = i_5 + 1) {
...
nlmulret_nelua_vector_block__assembler_error_t assembler_run_step(nelua_vector_block_ in_block, function_4P4HaANwYZrJRL5hJ step, int64_t addr_size) {
...
main_arg_flags main_parse_args() {
  main_arg_flags flags = (main_arg_flags){false, false, ((nlstring){(uint8_t*)"", 0}), ((nlstring){(uint8_t*)"", 0}), -1, true, -1, 0, false, false, false};
  int64_t i = 1;
  bool conv_ok = false;
...
nlstring main_make_start_runtime(main_arg_flags flags) {
  ...
  nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)nelua_strlit_4, 1244}));
  if((!flags.no_prefix)) {
