...
/* Compile hash: 235pMMXw1fCvMhy368PRbWtNUzRd */
/* ------------------------------ DIRECTIVES -------------------------------- */
#ifdef __GNUC__
  #ifndef __cplusplus
...
typedef nlmulret_nlboolean_nlint64_nlpointer (*function_4bSwUv7GoW6WnE9xj)(nelua_vector_pointer__ptr, int64_t);
typedef struct nlmulret_function_4bSwUv7GoW6WnE9xj_nelua_vector_pointer__ptr_nlint64 {
  function_4bSwUv7GoW6WnE9xj r1;
  nelua_vector_pointer__ptr r2;
  int64_t r3;
} nlmulret_function_4bSwUv7GoW6WnE9xj_nelua_vector_pointer__ptr_nlint64;
static nelua_inline nlmulret_function_4bSwUv7GoW6WnE9xj_nelua_vector_pointer__ptr_nlint64 nelua_ipairs_1(nelua_vector_pointer__ptr a);
...
typedef nlmulret_nlboolean_nlstring_nluint64 (*function_4c7a2CPSvZvAW172N)(nelua_hashmap_iteratorT_1_ptr, nlstring);
typedef struct nlmulret_function_4c7a2CPSvZvAW172N_nelua_hashmap_iteratorT_1_nlstring {
  function_4c7a2CPSvZvAW172N r1;
  nelua_hashmap_iteratorT_1 r2;
  nlstring r3;
} nlmulret_function_4c7a2CPSvZvAW172N_nelua_hashmap_iteratorT_1_nlstring;
static nelua_inline nlmulret_function_4c7a2CPSvZvAW172N_nelua_hashmap_iteratorT_1_nlstring nelua_pairs_1(nelua_hashmap_string__uint64__ptr a);
...
static nelua_inline nlmulret_function_4c7a2CPSvZvAW172N_nelua_hashmap_iteratorT_1_nlstring nelua_hashmap_string__uint64____pairs(nelua_hashmap_string__uint64__ptr self);
...
typedef nlmulret_nelua_vector_block__assembler_error_t (*function_52MqoB6N3dhydH1BC)(nelua_vector_block_, int64_t);
static nlmulret_nelua_vector_block__assembler_error_t assembler_run_step(nelua_vector_block_ in_block, function_52MqoB6N3dhydH1BC step, int64_t addr_size);
...
nlmulret_function_4bSwUv7GoW6WnE9xj_nelua_vector_pointer__ptr_nlint64 nelua_ipairs_1(nelua_vector_pointer__ptr a) {
  return (nlmulret_function_4bSwUv7GoW6WnE9xj_nelua_vector_pointer__ptr_nlint64){nelua_ipairs_next, a, -1};
}
nlmulret_function_4c7a2CPSvZvAW172N_nelua_hashmap_iteratorT_1_nlstring nelua_pairs_1(nelua_hashmap_string__uint64__ptr a) {
  nlmulret_function_4c7a2CPSvZvAW172N_nelua_hashmap_iteratorT_1_nlstring _ret_1 = nelua_hashmap_string__uint64____pairs(a);
  return (nlmulret_function_4c7a2CPSvZvAW172N_nelua_hashmap_iteratorT_1_nlstring){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
...
nlmulret_function_4c7a2CPSvZvAW172N_nelua_hashmap_iteratorT_1_nlstring nelua_hashmap_string__uint64____pairs(nelua_hashmap_string__uint64__ptr self) {
  return (nlmulret_function_4c7a2CPSvZvAW172N_nelua_hashmap_iteratorT_1_nlstring){nelua_hashmap_iteratorT_1_next, (nelua_hashmap_iteratorT_1){.container = self, .index = UINTPTR_MAX}, (nlstring){0}};
}
...
void nelua_GC_sweep(nelua_GC_ptr self) {
  ...
  if(finalize) {
    {
      nlmulret_function_4bSwUv7GoW6WnE9xj_nelua_vector_pointer__ptr_nlint64 _asgnret_3 = nelua_ipairs_1((&self->frees));
      function_4bSwUv7GoW6WnE9xj __fornext = _asgnret_3.r1;
  ...
  {
    nlmulret_function_4bSwUv7GoW6WnE9xj_nelua_vector_pointer__ptr_nlint64 _asgnret_5 = nelua_ipairs_1((&self->frees));
    function_4bSwUv7GoW6WnE9xj __fornext = _asgnret_5.r1;
...
nlmulret_nelua_filestream_nlstring_nlint64 nelua_filestream_open_1(nlstring filename, nlstring mode) {
  nelua_assert_line_62(nelua_checkmode(mode), ((nlstring){(uint8_t*)"invalid mode", 12}));
...
void assembler_print_labels(nelua_hashmap_string__uint64_ map) {
  nelua_stringbuilderT builder = {0};
  {
    nlmulret_function_4c7a2CPSvZvAW172N_nelua_hashmap_iteratorT_1_nlstring _asgnret_1 = nelua_pairs_1((&map));
    function_4c7a2CPSvZvAW172N __fornext = _asgnret_1.r1;
...
nlmulret_nelua_vector_block__assembler_error_t assembler_run_step(nelua_vector_block_ in_block, function_52MqoB6N3dhydH1BC step, int64_t addr_size) {
...
nlstring main_make_start_runtime(main_arg_flags flags) {
  ...
  if((word_size == 64)) {
    ...
    nelua_stringbuilderT_write_1((&builder), nelua_tostring_2(nelua_tointeger_2((word_size / (double)8), NLNIL)));
    nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)"\n@end\n", 6}));
  }
