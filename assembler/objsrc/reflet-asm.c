...
/* Compile hash: 2z2aWruWn2hkUayEvsDDjo9BpZ3e */
/* ------------------------------ DIRECTIVES -------------------------------- */
...
nlstring main_make_start_runtime(main_arg_flags flags) {
  ...
  nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)nelua_strlit_4, 1557}));
  if((!flags.no_prefix)) {
