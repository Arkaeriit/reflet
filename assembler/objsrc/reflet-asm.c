...
/* Compile hash: 3GKBdHGTdVYzLugkceEpZGfoYCY4 */
/* ------------------------------ DIRECTIVES -------------------------------- */
#ifdef __GNUC__
  #ifndef __cplusplus
...
typedef nlmulret_nlboolean_nlint64_nlpointer (*function_2ZSRTbQvAfPETGgd1)(nelua_vector_pointer__ptr, int64_t);
typedef struct nlmulret_function_2ZSRTbQvAfPETGgd1_nelua_vector_pointer__ptr_nlint64 {
  function_2ZSRTbQvAfPETGgd1 r1;
  nelua_vector_pointer__ptr r2;
  int64_t r3;
} nlmulret_function_2ZSRTbQvAfPETGgd1_nelua_vector_pointer__ptr_nlint64;
static nelua_inline nlmulret_function_2ZSRTbQvAfPETGgd1_nelua_vector_pointer__ptr_nlint64 nelua_ipairs_1(nelua_vector_pointer__ptr a);
...
typedef nlmulret_nlboolean_nlstring_nluint64 (*function_3Pax239B5ZrXTDvvC)(nelua_hashmap_iteratorT_1_ptr, nlstring);
typedef struct nlmulret_function_3Pax239B5ZrXTDvvC_nelua_hashmap_iteratorT_1_nlstring {
  function_3Pax239B5ZrXTDvvC r1;
  nelua_hashmap_iteratorT_1 r2;
  nlstring r3;
} nlmulret_function_3Pax239B5ZrXTDvvC_nelua_hashmap_iteratorT_1_nlstring;
static nelua_inline nlmulret_function_3Pax239B5ZrXTDvvC_nelua_hashmap_iteratorT_1_nlstring nelua_pairs_1(nelua_hashmap_string__uint64__ptr a);
...
static nelua_inline nlmulret_function_3Pax239B5ZrXTDvvC_nelua_hashmap_iteratorT_1_nlstring nelua_hashmap_string__uint64____pairs(nelua_hashmap_string__uint64__ptr self);
...
nlmulret_function_2ZSRTbQvAfPETGgd1_nelua_vector_pointer__ptr_nlint64 nelua_ipairs_1(nelua_vector_pointer__ptr a) {
  return (nlmulret_function_2ZSRTbQvAfPETGgd1_nelua_vector_pointer__ptr_nlint64){nelua_ipairs_next, a, -1};
}
nlmulret_function_3Pax239B5ZrXTDvvC_nelua_hashmap_iteratorT_1_nlstring nelua_pairs_1(nelua_hashmap_string__uint64__ptr a) {
  nlmulret_function_3Pax239B5ZrXTDvvC_nelua_hashmap_iteratorT_1_nlstring _ret_1 = nelua_hashmap_string__uint64____pairs(a);
  return (nlmulret_function_3Pax239B5ZrXTDvvC_nelua_hashmap_iteratorT_1_nlstring){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
...
nlmulret_function_3Pax239B5ZrXTDvvC_nelua_hashmap_iteratorT_1_nlstring nelua_hashmap_string__uint64____pairs(nelua_hashmap_string__uint64__ptr self) {
  return (nlmulret_function_3Pax239B5ZrXTDvvC_nelua_hashmap_iteratorT_1_nlstring){nelua_hashmap_iteratorT_1_next, (nelua_hashmap_iteratorT_1){.container = self, .index = UINTPTR_MAX}, (nlstring){0}};
}
...
void nelua_GC_sweep(nelua_GC_ptr self) {
  ...
  if(finalize) {
    {
      nlmulret_function_2ZSRTbQvAfPETGgd1_nelua_vector_pointer__ptr_nlint64 _asgnret_3 = nelua_ipairs_1((&self->frees));
      function_2ZSRTbQvAfPETGgd1 __fornext = _asgnret_3.r1;
  ...
  {
    nlmulret_function_2ZSRTbQvAfPETGgd1_nelua_vector_pointer__ptr_nlint64 _asgnret_5 = nelua_ipairs_1((&self->frees));
    function_2ZSRTbQvAfPETGgd1 __fornext = _asgnret_5.r1;
...
bool assemble_line_is_reg_valid(nlstring reg) {
  ...
  if((nelua_nlstring___len(reg) == 2)) {
    number_1 = nelua_nlstring___concat_1(((nlstring){(uint8_t*)"0x", 2}), nelua_nlstring_sub_1(reg, 2, nelua_nlstring___len(reg)));
  } else {
...
uint8_t assemble_line_reg_to_num(nlstring reg) {
  ...
  nlstring number_2 = {0};
  if((nelua_nlstring___len(reg) == 2)) {
    number_2 = nelua_nlstring___concat_1(((nlstring){(uint8_t*)"0x", 2}), nelua_nlstring_sub_1(reg, 2, nelua_nlstring___len(reg)));
  } else {
...
void assembler_print_labels(nelua_hashmap_string__uint64_ map) {
  nelua_stringbuilderT builder = {0};
  {
    nlmulret_function_3Pax239B5ZrXTDvvC_nelua_hashmap_iteratorT_1_nlstring _asgnret_1 = nelua_pairs_1((&map));
    function_3Pax239B5ZrXTDvvC __fornext = _asgnret_1.r1;
...
nlstring main_make_start_runtime(main_arg_flags flags) {
  ...
  nelua_stringbuilderT_write_1((&builder), ((nlstring){(uint8_t*)nelua_strlit_4, 1106}));
  if((!flags.no_prefix)) {
